        ...
        {livreList && livreList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('iSBN')}>
                  <Translate contentKey="calBiblioApp.livre.iSBN">I SBN</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nom')}>
                  <Translate contentKey="calBiblioApp.livre.nom">Nom</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('maisonEdition')}>
                  <Translate contentKey="calBiblioApp.livre.maisonEdition">Maison Edition</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="calBiblioApp.livre.home.notFound">No Livres found</Translate>
            </div>
          )
        )}
      </div>
      {props.totalItems ? (
        <div className={livreList && livreList.length > 0 ? '' : 'd-none'}>
